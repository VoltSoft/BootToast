 ...
 * boottoast.js
 * version: 1.0.0
 * author: Andrey Surzhikov <andrey.surzhikov@gmail.com>
 * license: MIT
 * Forked from: https://lettucebo.github.io/boottoast/
 */
(function(root, factory) {
  ...
  var templates = {
    dialog:
      '<div class="toast boottoast mb-1" role="alert" aria-live="assertive" aria-atomic="true">' +
      '  <div class="boottoast-content">' +
      '  <div class="toast-header">' +

      '    <strong class="me-auto toast-title"></strong>' +
      '    <small class="toast-small-title">11 mins ago</small>' +
      '  </div>' +
  ...
  exports.dialog = function(options) {
    ...
    var targetPositionDivClass =
      positionDivClass +
      "-" +
      options.horizontalPlacement +
      "-" +
      options.verticalPlacement;
    var positionContainer = $("." + targetPositionDivClass);
    ...
    if (
      ...
      if (options.horizontalPlacement === "left") {
        ...
        throw new Error("horizontalPlacement must be left, center or right.");
      }
      ...
      if (options.verticalPlacement === "top") {
        ...
        throw new Error("verticalPlacement must be top, center or buttom.");
      }

      styleStr += " z-index:9999; ";

      positionContainer = $("<div>", {
        class: targetPositionDivClass,
        style: styleStr
      });
    ...
    if (options.iconClass) {
      var div = $("<div>", {
        class: "rounded me-1 " + options.iconClass,
      });
      header.prepend(div);
    ...
    $(positionContainer).append(dialog);
